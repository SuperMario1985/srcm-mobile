<template>
  <div>
    ...
    >
      <cover-view class="back-button" @click="back" v-if="!isFullScreen && showBackBtn">
        <image src="../../static/yy-video-player/back-white.png" class="back-icon"></image>
      </cover-view>
      ...
      <!--      </cover-view>-->
      <cover-view v-if="showDownloadBtn&&isFullScreen" style="width:100%;margin: 0"
                  class="download-icon-horizontal" @click="download(url)">
        <image v-if="!isDownloading" src="../../static/yy-video-player/download.png" class="back-icon"></image>
