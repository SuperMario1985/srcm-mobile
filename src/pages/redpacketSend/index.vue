	...
	export default {
		...
		methods: {
			...
			async getInfoData () {
				...
				const {data: res} = await this.axios.post("redpacket-open/send-redpacket-index", {
				...
				if (res.error != 0) {
					...
					if (res.data.resData.isOpen == 1) {
						// uni.navigateTo({
						// 	url: '/pages/redpacketSend/list?corp_id=' + this.getParameter('corpid') + '&assist=' + this.getParameter('assist') + '&agent_id=' + this.getParameter('agent_id')
						// });
						window.location.href = this.$store.state.h5Url + '/h5/pages/redpacketSend/list?corp_id=' + this.getParameter('corpid') + '&assist=' + this.getParameter('assist') + '&agent_id=' + this.getParameter('agent_id')
					}
			...
			async openRed () {
				...
				const {data: res} = await this.axios.post("redpacket-open/send-redpacket-open", {
